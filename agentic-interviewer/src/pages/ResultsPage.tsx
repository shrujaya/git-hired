...
// Professional interview completion page with blue theme
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-blue-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-teal-400/20 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4 sm:p-6">
        <div className="max-w-4xl w-full">
          {/* Main Success Card */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-blue-100 p-8 sm:p-12 mb-6 text-center transform transition-all">
            {/* Success Icon */}
            <div className="mb-6">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center mx-auto shadow-lg animate-bounce-once">
            ...
            <p className="text-lg sm:text-xl text-gray-600 mb-8">
              Great job, <span className="font-semibold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">{userName}</span>! 
              You've successfully completed the <span className="font-semibold">{jobTitle}</span> interview.
            </p>

            {/* Decorative Line */}
            <div className="flex items-center justify-center mb-8">
              <div className="h-1 w-24 bg-gradient-to-r from-transparent via-blue-500 to-transparent rounded"></div>
            </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    email with feedback and next steps within <span className="font-semibold text-blue-600">3-5 business days</span>.
                  </p>
                </div>
              </div>

              <div className="flex items-center gap-2 text-sm text-gray-600 bg-white/80 backdrop-blur-sm rounded-lg px-4 py-3 border border-blue-100">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {/* Time Spent */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-5 text-center transform hover:scale-105 transition-transform">
            ...
            {/* Status */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-5 text-center transform hover:scale-105 transition-transform">
              <div className="w-12 h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-lg flex items-center justify-center mx-auto mb-3 shadow-md">
            ...
            {/* Position */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-5 text-center transform hover:scale-105 transition-transform">
              <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-3 shadow-md">
            ...
            {/* AI Powered */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-5 text-center transform hover:scale-105 transition-transform">
              <div className="w-12 h-12 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center mx-auto mb-3 shadow-md">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-6">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <Star className="w-4 h-4 text-cyan-600 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-xl shadow-lg border border-blue-200 p-6 mb-6 text-white">
          ...
          {/* Feedback Section */}
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-blue-100 p-6 mb-6">
            ...
            <div className="flex justify-center gap-2 mb-4">
              {[1, 2, 3, 4, 5].map((rating) => (
                <button
                  key={rating}
                  className="w-12 h-12 rounded-full border-2 border-blue-200 hover:border-blue-400 hover:bg-blue-50 transition-all flex items-center justify-center group"
                >
                  <Star className="w-6 h-6 text-gray-400 group-hover:text-blue-500 group-hover:fill-blue-500 transition-all" />
                </button>
              ))}
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex items-center justify-center gap-2"
            >
            ...
            <button
              ...
              className="px-8 py-4 bg-white/80 backdrop-blur-sm border-2 border-blue-200 hover:border-blue-400 text-gray-700 hover:text-blue-600 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              Questions? Email us at <a href="mailto:support@company.com" className="text-blue-600 hover:underline font-medium">support@company.com</a>
            </p>
